      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border-2 border-white/50">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-40 h-40 mb-2 transform hover:scale-105 transition-transform duration-300 drop-shadow-2xl">
        ...
        <div className="text-center mt-6">
          <p className="text-white/80 text-sm font-medium">
            Sistema v1.0 - Hospital Universitario San Rafael de Tunja © 2026
          </p>
        </div>
      </div>
    </div>
